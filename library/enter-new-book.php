...
// First we execute our common code to connection to the database and start the session 
    ...
    ?>
        ...
        <font color="blue">Enter new Book in Database.</font>
		<br>
		<br>
...
<form action="enter-new-book2.php" method="post">
<table>
<tr><td>Book Name:</td> <td><input type="text" name="bookname" /></td></tr>
<tr><td>Author Name:</td> <td><input type="text" name="bookauthor" /></td></tr>
<tr><td>Book Edition:</td> <td><input type="text" name="booked" /></td></tr>
<tr><td>Book Subject:</td> <td><input type="text" name="booksubject" /></td></tr>
<tr><td>Number of copies:</td> <td><input type="text" name="booknoc" /></td></tr>
</table>
